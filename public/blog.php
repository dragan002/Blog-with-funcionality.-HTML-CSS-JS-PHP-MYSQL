        ...
        <div class="container posts__container">
            <article class="post">
                <div class="post__thumbnail">
                    <img src="images/pexels-dziana-hasanbekava-6401669.jpg" alt="">
                </div>
                <div class="post__info">
                    <a href="" class="category__button">Wild Life</a>
                    <h3 class="post__title">
                        <a href="posts.php">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, adipisci.</a>
                    </h3>
                    <p class="post__body">
            ...
            <article class="post">
                ...
                <div class="post__info">
                    ...
                    <div class="post__author">
                        <div class="post__author-avatar">
                            <img src="images/pexels-kindel-media-7294592.jpg" alt="">
                        </div>
                        <div class="post__author-info">
                            <h3>Dragan</h3>
                            <small>June 26, 2023</small>
